...
public class AccountService {
    ...
    private Account createAccount(String[] data) {
        ...
        if (data[2].equals("CHECKING")) {
            return new CheckingAccount(data[0], balance, overdraftCount, accountActive, cardType);
        } else if (data[2].equals("SAVINGS")) {
            return new SavingsAccount(data[0], balance, overdraftCount, accountActive, cardType);
        }
        ...
        try {
            ...
            for (String line : lines) {
                ...
                if (data[0].equals(fromAccountId)) {
                    ...
                    fromAccount = createAccount(data);
                }

                if (data[0].equals(toAccountId)) {
                    toCustomerId = data[1];
                    toAccount = createAccount(data);
                }
            }
